...
DJ_LIST = [
    ...
    ("Acid Pauli",           "https://ra.co/dj/acidpauli"),
    ("Âme",                  "https://ra.co/dj/ame"),
    ("Carlita",              "https://ra.co/dj/carlita"),
    ("Eric Prydz",           "https://ra.co/dj/ericprydz"),
    ("Kasablanca",           "https://ra.co/dj/kasablanca"),
    ("Lane 8",               "https://ra.co/dj/lane8"),
    ("DJ Tennis",            "https://ra.co/dj/djtennis"),
    ("Michael Bibi",         "https://ra.co/dj/michaelbibi"),
    ("Mind Against",         "https://ra.co/dj/mindagainst"),
    ("Miss Monique",         "https://ra.co/dj/missmonique"),
    ("Monolink",             "https://ra.co/dj/monolink"),
    ("Sammy Virji",          "https://ra.co/dj/sammyvirji"),
    ("Seth Troxler",         "https://ra.co/dj/sethtroxler"),
    ("Dennis Cruz",          "https://ra.co/dj/denniscruz"),
    ("The Martinez Brothers","https://ra.co/dj/themartinezbros"),
    ("Sparrow & Barbossa",   "https://ra.co/dj/sparrowbarbossa"),
    ("Boddhi Satva",         "https://ra.co/dj/boddhisatva"),
    ("Themba",               "https://ra.co/dj/themba"),
    ("FISHER",               "https://ra.co/dj/fisheroz"),
    ("Chris Lake",           "https://ra.co/dj/chrislake"),
    ("MK",                   "https://ra.co/dj/marckinchen"),
    ("Dixon",                "https://ra.co/dj/dixon"),
    ("Massano",              "https://ra.co/dj/massano"),
    ("PAWSA",                "https://ra.co/dj/pawsa"),
    ("ANOTR",                "https://ra.co/dj/anotr"),
    ("Elderbrook",           "https://ra.co/dj/elderbrook"),
]
# ─────────────────────────────────────────────────────────────────────────────
